function BestSol = optimize_CMA(CostFunction, nVar, VarMin, VarMax,MaxIt)
% CostFunction: cost function
% nVar: number of variables to be optimized 
% VarMin: value of the lower boundary (a single value for all variables) 
% VarMax: value of the upper boundary (a single value for all variables)
